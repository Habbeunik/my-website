					...
					<div className="flex justify-center mt-12">
						<div className="flex flex-row gap-6">
							<a
								...
								className="p-4 border border-muted-foreground/20 text-muted-foreground hover:text-foreground hover:border-muted-foreground/40 transition-all duration-300 rounded-xl"
								aria-label="GitHub">
								<svg
									className="w-6 h-6"
									fill="currentColor"
