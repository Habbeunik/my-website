        ...
        <div className="flex flex-col gap-16">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <P className="text-xl md:text-2xl lg:text-3xl text-foreground leading-relaxed font-light tracking-[-0.02em]">
              I build intelligent, scalable products that connect ideas to
              impact.
            </P>
          </div>
          ...
          <div className="flex flex-col items-center gap-10 pt-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#projects"
                className="group relative bg-foreground text-background px-10 py-4 rounded-lg font-semibold hover:opacity-90 transition-all duration-300 text-center shadow-lg hover:shadow-xl hover:scale-105"
              >
                See my work
              </a>
              <a
                href="#chat-with-me"
                className="group relative border-2 border-foreground/50 text-foreground px-10 py-4 rounded-lg font-semibold hover:bg-foreground hover:text-background transition-all duration-300 text-center hover:border-foreground hover:scale-105"
              >
                Let's build together
              </a>
            </div>

            <div className="flex flex-row gap-4 md:gap-6 pt-2">
              <a
                href="https://github.com/Habbeunik"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 md:p-4 border border-muted-foreground/30 text-muted-foreground hover:text-foreground hover:border-muted-foreground/60 hover:bg-background/80 transition-all duration-300 rounded-xl bg-background/40 backdrop-blur-sm hover:scale-110"
                aria-label="GitHub"
              >
                <svg
